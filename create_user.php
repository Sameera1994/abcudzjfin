...
<form id="contactForm" method="post" class="form-horizontal"  action="create.php">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <input type="text" class="form-control" required=""  name="UID"  id="UID"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <input type="password" class="form-control"  required="" name="UPW" id="UPW" />
        </div>
    </div>
    <div class="form-group">
