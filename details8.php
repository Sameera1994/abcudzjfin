...
<body>
  ...
  <div class="page-header">
    <br><br>
                <h2 align='center'>Employees Requested for Accomadation(House)</h2>
...
$user_details = 'SELECT users.NIC, users.NameWI,users.Room_house_Type,users.marks,users.AppDate,users.Designation,users.Ho_ro_order FROM users INNER JOIN designation on designation.name=users.Designation WHERE users.Accommodation_type="house" and users.Nacc is null ORDER BY designation.cat asc, users.AppDate asc ';
   ...
   while($array = mysqli_fetch_array($result)) 
    ...
    $Acc_details = 'SELECT house_no ,house_type FROM house WHERE emp_nic is null ';
...
?>
    ...
    <div class="page-header">
                <h2 align='center'>Assaigning Accomadation(House)</h2>
                
            </div>
    <form id="contactForm" class="form-horizontal" role="form" method="post" action="assaing_h.php">
  ...
  <div class="form-group">
    <label for="inputName" class="col-sm-2 control-label">House number </label>
    <div class="col-sm-10">
