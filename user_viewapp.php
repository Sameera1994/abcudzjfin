 ...
 $sql = "SELECT *  FROM users WHERE UPF='$_SESSION[NIC]' ORDER BY AppDate DESC LIMIT 1";
  ...
  while($row = mysqli_fetch_array($retval, MYSQL_NUM)) {
    ...
    echo '<div class="col-sm-6 col-sm-offset-2">';
     ...
     echo '<div class="col-sm-6">';
     echo '<input type="text" class="form-control id="23" name="23"" value="'."{$row[26]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
     echo '</div>';
     echo '<div class="form-group">';
     ...
     echo '<div class="col-sm-6">';
     echo '<input type="text" class="form-control" id="25" name="25" value="'."{$row[28]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
     echo '</div>';
     echo '<div class="form-group">';
     echo '<label class="col-sm-3 control-label">'.'District'.'</label>';
     echo '<div class="col-sm-6">';
     echo '<input type="text" class="form-control" id="26" name="26" value="'."{$row[29]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
     echo '</div>';
	  echo '<div class="form-group">';
     echo '<label class="col-sm-3 control-label">'.'Designation'.'</label>';
     echo '<div class="col-sm-6">';
     echo '<input type="text" class="form-control" id="27" name="27" value="'."{$row[35]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
     echo '</div>';
     echo '<div class="form-group">';
     echo '<label class="col-sm-3 control-label">'.'Employement'.'</label>';
     echo '<div class="col-sm-6">';
     echo '<input type="text" class="form-control" id="28" name="28" value="'."{$row[30]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
     echo '</div>';
     echo '<div class="form-group">';
     echo '<label class="col-sm-3 control-label">'.'Duration'.'</label>';
     echo '<div class="col-sm-2">';
     echo '<label ">'.'Years'.'</label>'.'<input type="text" class="form-control" id="29" name="29" value="'."{$row[32]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
     echo '<div class="col-sm-2">';
     echo '<label ">'.'Months'.'</label>'.'<input type="text" class="form-control" id="30" name="30" value="'."{$row[33]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
     echo '</div>';
     echo '<div class="form-group">';
     echo '<label class="col-sm-3 control-label">'.' workplace Address'.'</label>';
     echo '<div class="col-sm-6">';
     echo '<input type="text" class="form-control" id="31" name="31" value="'."{$row[41]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
     echo '</div>';
     echo '<div class="form-group">';
