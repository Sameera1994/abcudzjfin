 ...
 $sql = "SELECT *  FROM users WHERE UPF='$_SESSION[NIC]' ORDER BY AppDate DESC LIMIT 1";
  ...
  while($row = mysqli_fetch_array($retval, MYSQL_NUM)) {
    ...
    echo '<div class="col-sm-6 col-sm-offset-2">';
     ...
     echo '<label ">'.'Permanant Years'.'</label>'.'<input type="text" class="form-control" id="14" name="14" value="'."{$row[19]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
     echo '<div class="col-sm-2">';
     echo '<label ">'.'permanant Months'.'</label>'.'<input type="text" class="form-control" id="15" name="15" value="'."{$row[20]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
      echo '<div class="col-sm-2">';
     echo '<label ">'.'temporary years'.'</label>'.'<input type="text" class="form-control" id="16" name="16" value="'."{$row[21]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
      echo '<div class="col-sm-2">';
     echo '<label ">'.'temporary Months'.'</label>'.'<input type="text" class="form-control" id="17" name="17" value="'."{$row[22]}" .'"placeholder="Ex: John Watson" readonly/>';
     echo '</div>';
     echo '</div>';
